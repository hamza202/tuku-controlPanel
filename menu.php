...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
    ...
    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark "
        ...
        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                    ...
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="users.php"
                               class="m-menu__link "><i
                                        ...
                                        class="m-menu__link-text">مستخدمين</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="comp.php"
                        ...
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="drivers.php"
                               class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">سائقين</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="disabled-driver.php"
                               class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">سائقين معلقين</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
                        href="javascript:;" class="m-menu__link m-menu__toggle"><i
                            class="m-menu__link-icon la la-cubes"></i><span class="m-menu__link-text">الطلبات</span><i
                            class="m-menu__ver-arrow la la-angle-right"></i></a>
                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item " aria-haspopup="true">
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="driver-map.php" class="m-menu__link m-menu__toggle">
                    <i class="m-menu__link-icon fas fa-map-marked-alt">
                    </i><span class="m-menu__link-text">خريطة السائقين</span>
                </a>
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="web-control.php" class="m-menu__link m-menu__toggle">
                    <i class="m-menu__link-icon fas fa-sitemap">
                    </i><span class="m-menu__link-text">التحكم بالموقع</span>
                </a>

            </li>
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
                        href="javascript:;" class="m-menu__link m-menu__toggle"><i
                            class="m-menu__link-icon  far fa-copy"></i><span
                            class="m-menu__link-text">صفحات الموقع</span><i
                            class="m-menu__ver-arrow la la-angle-right"></i></a>
                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="about-us.php"
                               class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">من نحن</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="work-method.php" class="m-menu__link ">
                                <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                <span class="m-menu__link-text">آلية العمل</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
                        ...
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="privacy.php" class="m-menu__link ">
                                <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                    ...
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="packages.php"
                               class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">انواع الطرود</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="car-type.php" class="m-menu__link ">
                                <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                <span class="m-menu__link-text">انواع السيارات</span>
                            </a>
                        </li>
                    </ul>
                </div>
