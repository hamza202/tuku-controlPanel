...
<head>
    <meta charset="utf-8"/>
    <title>توكو || انواع السيارات</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">انواع السيارات</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form action="#" id="user_register_form" data-parsley-validate="" data-parsley-trigger="change">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">اضافة نوع سيارة جديدة</h5>
                    ...
                    <div class="row ">
                        <div class="col-lg-12">
                            <div class="form-group m-form__group mb-4">
                                ...
                                <input required type="text" placeholder=" نوع السيارة" name="user_name"
...
<div class="modal fade" id="m_modal_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <form action="#">
        ...
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل نوع السيارة</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control m-input" required aria-describedby="emailHelp"
                               value="نوع2" placeholder="نوع السيارة">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلاق</button>
