...
<head>
    <meta charset="utf-8"/>
    <title>توكو || سياسة الخصوصية</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">سياسة الخصوصية</h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="m-portlet__body">
                        <form action="#">
                            <div class="form-group m-form__group">
                                <label for="exampleTextarea">تعديل نص سياسة الخصوصية</label>
                                <textarea class="form-control m-input" required id="exampleTextarea" rows="5">
