...
<head>
    <meta charset="utf-8"/>
    <title>توكو || تفاصيل الباقات</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">تفاصيل الباقة</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                <tr>
                                    ...
                                    <td>12345</td>
                                    <td>
                                        <button type="button" data-toggle="modal" data-target="#m_modal_7" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only">
                                            <i class="fa fa-trash-alt"></i>
                                        </button>
                                    </td>
                                    <td>
                                        <a href="existing-requests-details.php" class="btn btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--custom
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="#" id="user_register_form" data-parsley-validate="" data-parsley-trigger="change">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">اضافة طلب الى الباقة</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-12">
                            <div class="form-group m-form__group mb-4">
                                ...
                                <input required type="number" placeholder="رقم الطلب"
...
<div class="modal fade" id="m_modal_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <form action="#">
        ...
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل اسم الباقة</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control m-input" required aria-describedby="emailHelp"
                               value="باقة2" placeholder="اسم الباقة">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلاق</button>
...
<script>
    var DatatablesBasicHeaders = {
        init: function () {
            $("#m_table_1").DataTable({
                dom: "<'row'<'col-6 col-md-4'l><'col-6 col-md-4 my-d-button text-center'B><'col-sm-12 col-md-4'f>>",
